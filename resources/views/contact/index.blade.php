        ...
        <div class="contactMainBox">
            <form action="{{route('contact.confirm')}}"method="POST">
                ...
                <div class="contactItem">
                    ...
                    <div class="inputItem">
                        <input type="text" id="name" name="name" value="{{old('name')}}" class="textInput" placeholder="例）田中太郎">
                        @error('name')
                            <span class="errorMessage">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="contactItem">
                    ...
                    <div class="inputItem">
                        <input type="text" id="phone" name="phone" value="{{old('phone')}}" class="textInput" placeholder="例）090-〇〇〇〇-〇〇〇〇">
                        @error('phone')
                            <span class="errorMessage">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="contactItem">
                    ...
                    <div class="inputItem">
                        <input type="date" id="birthday" name="birthday" value="{{old('birthday')}}" class="dateInput" placeholder="例）1月1日">
                        @error('birthday')
                            <span class="errorMessage">{{$message}}</span>
                        @enderror
                    </div>
